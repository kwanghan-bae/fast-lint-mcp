...
describe('v4.2 커버리지 인사이트 및 상시 노출 검증', () => {
  ...
  it('PASS 케이스에서도 커버리지 수치가 메타데이터에 포함되고 Top 3 취약 파일이 노출되어야 한다', async () => {
    ...
    const lcovContent = [
      'SF:src/perfect.ts', 'LF:10', 'LH:10', 'end_of_record',
      'SF:src/weak1.ts', 'LF:10', 'LH:5', 'end_of_record',
      'SF:src/weak2.ts', 'LF:10', 'LH:6', 'end_of_record',
      'SF:src/weak3.ts', 'LF:10', 'LH:7', 'end_of_record'
    ].join('\n');
