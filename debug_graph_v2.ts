...
async function verifyGraph() {
  ...
  writeFileSync(controllerPath, 'import { service } from "./service";\nimport { util } from "./utils";');
  ...
  const utilsCorrect = utilsDeps.some(d => d.endsWith('service.ts')) && utilsDeps.some(d => d.endsWith('controller.ts'));
