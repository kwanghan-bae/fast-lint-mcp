...
1.  **[사전 분석]**: 작업을 시작하기 전 `quality-check`를 호출하여 현재 코드의 품질 기준(Baseline)을 확인합니다.
2.  **[품질 인증 필수]**: 작업을 마치고 사용자에게 보고하기 전, 반드시 `quality-check` 도구를 호출해야 합니다.
...
**"품질은 타협의 대상이 아니며, 에이전트의 신뢰성은 이 품질 관문을 통과함으로써 증명됩니다."**
